  ...
  try {
    ...
    const defaultContent = [
      ...
      },
      {
        ...
        section: "hero",
        content_type: "text",
        content: "🍜 Now accepting pre-orders",
      },
      {
        id: "home_hero_title",
        page: "home",
      ...
      {
        id: "home_hero_title_highlight",
        page: "home",
        section: "hero",
        content_type: "text",
        content: "Tradition & Love",
      },
      {
      ...
      },
      {
        ...
        section: "cta",
        content_type: "text",
        content: "Ready to taste the tradition?",
      },
      {
